# pms7003 modular service

This module implements the [rdk sensor API](https://github.com/rdk/sensor-api) in a joyce:air-quality:pms7003 model.
...
To use this module, follow these instructions to [add a module from the Viam Registry](https://docs.viam.com/registry/configure/#add-a-modular-resource-from-the-viam-registry) and select the `rdk:sensor:joyce:air-quality:pms7003` model from the [`joyce:air-quality:pms7003` module](https://app.viam.com/module/rdk/joyce:air-quality:pms7003).
